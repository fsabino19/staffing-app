...
<div style="padding: 25px; background-color:#1f2937; border-radius:12px; margin-bottom:20px;">
    <h1 style="color:white; text-align:center; margin-bottom:5px;">NPC Staffing Calculator v2.1</h1>
...
if mode == "📦 Pallet-Based (Floor / PA)":
    ...
    # NEW — Angela's improvement
    ibd_received = st.number_input("IBD Pallets Received (total)", min_value=0.0, step=1.0)
    inflow_pallets_hr = ibd_received / SHIFT_HOURS

    st.caption(f"Auto‑calculated inflow rate: {inflow_pallets_hr:.2f} pallets/hr")
...
NPC Staffing Calculator • v2.1<br>
